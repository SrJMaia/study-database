...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `my_trigger` BEFORE INSERT ON `employee` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `my_trigger1` BEFORE INSERT ON `employee` FOR EACH ROW BEGIN
...
INSERT INTO `trigger_test` VALUES ('added new employee'),('added new employee'),('Kevin'),('added new employee'),('Pam');
...
-- Dump completed on 2021-07-20 12:34:59
